...
Note: Functions may have a `_memb` postfix due to C macro rewriting in urcu (in
case `sys_membarrier()` is available on the system).
https://github.com/jethrogb/rust-cexpr/issues/3
